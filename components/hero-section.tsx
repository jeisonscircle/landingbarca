...
export function HeroSection() {
  return (
    <section className="w-full bg-white pt-6 pb-8 md:pt-10 md:pb-12 px-4 md:px-6">
      <div className="max-w-5xl mx-auto">
        {/* Page title */}
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-[#0a1628] tracking-tight text-center mb-6 md:mb-10">
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6">
          ...
          <div className="flex flex-col">
            <h3 className="text-sm sm:text-base md:text-lg text-[#0a1628] mb-2 md:mb-3">
              Legendary <span className="font-bold">Barça drops.</span>
            </h3>
            <div className="relative aspect-[3/4] rounded-xl md:rounded-2xl overflow-hidden bg-[#1a1a2e]">
              <Image
              ...
              <div className="absolute bottom-3 left-3 md:bottom-4 md:left-4">
                <button className="bg-gradient-to-r from-[#FF6B5B] via-[#FF9D4D] to-[#FFD166] text-white rounded-full px-3 md:px-5 py-1.5 md:py-2 text-xs md:text-sm font-medium">
                  Discover the Drops
                </button>
              </div>
            </div>
            <p className="text-xs md:text-sm text-[#0a1628]/70 mt-2 md:mt-3 leading-relaxed">
          ...
          <div className="flex flex-col">
            ...
            <div className="relative aspect-[3/4] rounded-xl md:rounded-2xl overflow-hidden bg-[#0a1628]">
              <Image
