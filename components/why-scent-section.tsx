      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="flex flex-col justify-center md:col-span-1">
            <p className="text-base md:text-lg text-[#0a1628] font-normal leading-relaxed">
          ...
          {/* Right - Image */}
          <div className="relative aspect-[5/3] rounded-2xl overflow-hidden md:col-span-2">
            <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
          ...
          <div className="flex flex-col justify-center md:col-span-2">
            <p className="text-base md:text-lg text-[#0a1628] font-normal leading-relaxed mb-6">
            ...
            <button className="self-start bg-gradient-to-r from-[#FF6B5B] via-[#FF9D4D] to-[#FFD166] text-white rounded-full px-6 md:px-8 py-2.5 md:py-3 text-sm md:text-base font-semibold hover:opacity-90 transition-opacity">
              Discover the Drops
            </button>
          </div>
        </div>
