  ...
  return (
    <section className="bg-white py-12 md:py-16 px-4 md:px-6">
      <div className="max-w-5xl mx-auto">
        {/* Title */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-[#0a1628] font-normal tracking-tight leading-tight mb-6 md:mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-6">
          ...
          <div className="relative aspect-square rounded-lg md:rounded-2xl overflow-hidden">
            ...
            <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4">
              <h3 className="text-lg md:text-2xl text-white font-light italic">Aura</h3>
            </div>
          </div>

          {/* Scent Board */}
          <div className="relative aspect-square rounded-lg md:rounded-2xl overflow-hidden bg-black">
            <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
            <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4">
              <h3 className="text-lg md:text-2xl text-white font-medium">Scent Board</h3>
            </div>
          </div>

          {/* Scent Creator */}
          <div className="relative aspect-square rounded-lg md:rounded-2xl overflow-hidden bg-[#e8e8e8]">
            <Image
            ...
            <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4">
              <h3 className="text-lg md:text-2xl text-white font-medium">Scent Creator</h3>
            </div>
          </div>
        </div>
      </div>
